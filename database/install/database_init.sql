INSERT INTO `languages` (`id`, `uid`, `name`, `code`, `region_code`, `status`, `is_default`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `layouts` (`uid`, `alias`, `subject`, `group_name`, `content`, `type`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `plans` (`id`, `uid`, `admin_id`, `currency_id`, `name`, `price`, `frequency_amount`, `frequency_unit`, `options`, `status`, `created_at`, `updated_at`, `tax_billing_required`, `description`) VALUES
