    ...
    <div class="nk-content-body">
        ...
        <div class="nk-msg">
            <div class="nk-msg-aside">
                <div class="nk-msg-nav" style="padding: 0 0 0 10px;">
                    ...
                    <div class="nk-reply-item"  v-for="(chat, index) in ticketChats">
                        <div class="nk-reply-header" v-if="chat.message_belong == 'customer'">
                            <div class="user-card">
                                ...
                                <div class="user-name">{{ticketChat.supportuser.first_name}} {{ticketChat.supportuser.last_name}}</div>
                            </div>
                        ...
                        <div class="card-inner-group">
                            <div class="card-inner">
                                <div class="user-card user-card-s2 mb-2">
                                    ...
                                    <div class="user-info" v-if="ticketChat.supportuser">
                                        <h5>{{ticketChat.supportuser.first_name}} {{ticketChat.supportuser.last_name}}</h5>
                            ...
                            <div class="card-inner">
                                <div class="aside-wg">
                                    ...
                                    <ul class="user-contacts" v-if="ticketChat.supportuser">
                                        <li>
                                            <em class="icon ni ni-mail"></em><span>{{ticketChat.supportuser.email}}</span>
                                        </li>
                                        <li>
                                            <em class="icon ni ni-call"></em><span>{{ticketChat.supportuser.mobileno}}</span>
                                        </li>
                                        <li>
...
methods: {
     ...
     sendMessage() {
      ...
      formData.append("message_belong", 'admin');
