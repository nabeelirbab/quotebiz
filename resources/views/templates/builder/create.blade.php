...
@section('page_header')
    ...
    <div class="page-title">				
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url("templates") }}">{{ trans('messages.templates') }}</a></li>
        </ul>
        <h1>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ url('templates/builder/create') }}" method="POST" class="template-form form-validate-jquery">
                {{ csrf_field() }}
					...
					<div class="subsection pb-4">
						...
						<div id="gallery-{{ $category->id }}" class="pb-4">
							<div class="listing-form"
								data-url="{{ url('templates/builder/templates/'.$category->uid) }}"
								per-page="25"					
							>				
...
search
					...
					<script>
						$(function() {
							var list = makeList({
								url: '{{ url('templates/builder/templates/'.$category->uid) }}',
