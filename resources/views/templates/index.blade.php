...
@section('content')
    <div id="TemplatesIndexContainer" class="listing-form  view-{{ request()->view ? request()->view : 'list' }}"
        data-url="{{ url('templates/listing') }}"
                    ...
                    @if (!request()->view || request()->view == 'list')
                        ...
                        <div class="dropdown list_actions" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item" link-confirm="{{ trans('messages.delete_templates_confirm') }}" href="{{ url('templates/delete') }}">
...
search
            ...
            <div class="text-end d-flex align-items-center ms-auto">
                ...
                <div>
                    <a href="{{ url('templates/upload') }}" class="btn btn-light ml-auto">
                        <span class="material-icons-outlined">
    file_upload
    </span> {{ trans('messages.upload') }}
                    </a>  
                    <a href="{{ url('templates/builder/create') }}" class="btn btn-secondary">
                        <span class="material-icons-round">
    add
