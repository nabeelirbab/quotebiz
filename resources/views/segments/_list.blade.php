            ...
            <tr>
                ...
                <td>
                    <a class="kq_search text-bold d-block"
                        href="{{ url('lists/'.$list->uid.'/segments/'.$item->uid.'/subscribers') }}">
                        {{ $item->name }}
                    </a>
                ...
                <td class="text-end text-nowrap">
                    @if (\Gate::allows('update', $item))
                        <a href="{{ url('lists/'.$list->uid.'/segments/'.$list->uid.'/edit') }}"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            @if (\Gate::allows('delete', $item))
                                <li><a class="dropdown-item list-action-single"
                                       ...
                                       href="{{ url('lists/'.$list->uid.'/segments/delete', ['list_uid' => $list->uid, "uids" => $item->uid]) }}"><i
