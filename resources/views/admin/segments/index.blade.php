...
splitscreen
	...
	<div id="SegmentsIndexContainer" class="listing-form"
		data-url="{{ action('Admin\SegmentController@listing', $list->uid) }}"
					...
					<div class="filter-box">
						...
						<div class="btn-group list_actions me-2" style="display:none">
							...
							<ul class="dropdown-menu">
								<li>
									<a class="dropdown-item" link-confirm="{{ trans('messages.delete_segments_confirm') }}" href="{{ action('Admin\SegmentController@delete', $list->uid) }}">
...
search
			...
			<div class="text-end">
				<a href="{{ action("Admin\SegmentController@create", $list->uid) }}" role="button" class="btn btn-secondary">
					<span class="material-icons-round">
add
	...
	<script>
        var SegmentsIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('Admin\SegmentController@listing', $list->uid) }}',
