            ...
            <tr>
                ...
                <td>
                    <a class="kq_search text-bold d-block"
                        href="{{ action('Admin\SegmentController@subscribers', ['list_uid' => $list->uid, 'uid' => $item->uid]) }}">
                        {{ $item->name }}
                    </a>
                ...
                <td class="text-end text-nowrap">
                    @if (\Gate::allows('update', $item))
                        <a href="{{ action('Admin\SegmentController@edit', ['list_uid' => $list->uid, "uid" => $item->uid]) }}"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            @if (\Gate::allows('delete', $item))
                                <li><a class="dropdown-item list-action-single"
                                       ...
                                       href="{{ action('Admin\SegmentController@delete', ['list_uid' => $list->uid, "uids" => $item->uid]) }}"><i
