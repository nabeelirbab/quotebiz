...
people
	...
	<div class="listing-form" id="SegmentsSubscribersContainer"
		data-url="{{ action('Admin\SegmentController@listing_subscribers', ['list_uid' => $list->uid, 'uid' => $segment->uid]) }}"
...
add
	...
	<script>
		var SegmentsSubscribers = {
			getList: function() {
				return makeList({
					url: '{{ action('Admin\SegmentController@listing_subscribers', ['list_uid' => $list->uid, 'uid' => $segment->uid]) }}',
