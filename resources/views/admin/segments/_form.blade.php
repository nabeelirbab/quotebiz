								...
								<div class="segment-conditions-container">
									@foreach ($segment->segmentConditions as $condition)
										<div class="row condition-line" rel="{{ $condition->uid }}">
											...
											<div class="col-md-7 operator_value_col" data-url="{{ action('Admin\SegmentController@conditionValueControl') }}">
...
delete_outline
								...
								<br />
								<a sample-url="{{ action('Admin\SegmentController@sample_condition', $list->uid) }}" href="#add_condition" class="btn btn-info bg-teal-800 add-segment-condition">
