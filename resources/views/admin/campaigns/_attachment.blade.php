<div class="image_upload_div">
  <form action="{{ action('Admin\CampaignController@uploadAttachment', $campaign->uid) }}" class="dropzone">
     {{ csrf_field() }}
  </form>
</div>
      ...
      @foreach ($campaign->getAttachments() as $k=>$filename)
        ...
        <li class="d-flex align-items-canter py-2 border-top">
          ...
          <div class="text-nowrap">
            <a title="" class="tip-right" href="{{ action('Admin\CampaignController@downloadAttachment', [
              'uid' => $campaign->uid,
              'name' => $filename,
            ]) }}">
            ...
            |
            <a href="{{ action('Admin\CampaignController@removeAttachment', [
              'uid' => $campaign->uid,
              'name' => $filename,
