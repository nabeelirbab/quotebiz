<h3 class="mt-5 mb-3"><span class="material-icons-round me-2">
    ads_click
...
auto_awesome
        ...
        @else
            ...
            <div class="text-end">
                <a href="{{ action('Admin\CampaignController@clickLog', $campaign->uid) }}" class="btn btn-info bg-teal-600">{{ trans('messages.click_log') }} <span class="material-icons-round">
arrow_forward
</span></a>
            </div>
        @endif
    ...
    <div class="col-md-6">
        @if ($campaign->clickCount())
                ...
                <div class="">
                    <div class="chart-container has-scroll">
                        <div class="chart has-fixed-height"
                            ...
                            data-url="{{ action('Admin\CampaignController@chartClickCountry', $campaign->uid) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                var ClickPieChart = {
                    url: '{{ action('Admin\CampaignController@chartClickCountry', $campaign->uid) }}',
                    getChart: function() {
