            ...
            <tr>
                ...
                <td>
                    ...
                    @if (null !== $subscriber->lastOpenLog($campaign))
                        <a href="{{ action('Admin\CampaignController@openLog', ["uid" => $campaign->uid, "search_keyword" => $subscriber->email]) }}">
                ...
                <td>
                    ...
                    @if (null !== $subscriber->lastClickLog($campaign))
                        <a href="{{ action('Admin\CampaignController@clickLog', ["uid" => $campaign->uid, "search_keyword" => $subscriber->email]) }}">
