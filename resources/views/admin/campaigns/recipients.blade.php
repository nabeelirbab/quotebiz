...
@section('content')
    <form action="{{ action('Admin\CampaignController@recipients', $campaign->uid) }}" method="POST" class="form-validate-jqueryz recipients-form">
        {{ csrf_field() }}
        ...
        <div class="addable-multiple-form">
            ...
            <br />
            <a
                sample-url="{{ action('Admin\CampaignController@listSegmentForm', $campaign->uid) }}"
