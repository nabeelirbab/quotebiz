...
<div class="row">
            ...
            <div class="">
                <div class="chart-container">
                    <div id="campaignChart"
                        ...
                        data-url="{{ action('Admin\CampaignController@chart', $campaign->uid) }}"
    ...
    <div class="col-md-6">
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@openLog', $campaign->uid) }}"><span class="material-icons-outlined">
arrow_forward
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@subscribers', ['uid' => $campaign->uid, 'open' => 'not_opened']) }}"><span class="material-icons-outlined">
arrow_forward
</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@clickLog', $campaign->uid) }}"><span class="material-icons-outlined">
arrow_forward
</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@unsubscribeLog', $campaign->uid) }}"><span class="material-icons-outlined">
arrow_forward
</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@bounceLog', $campaign->uid) }}"><span class="material-icons-outlined">
arrow_forward
</span> {{ trans('messages.view_log') }}</a>
        </div>
        ...
        <div class="badge-row">
            ...
            <a class="text-warning" href="{{ action('Admin\CampaignController@feedbackLog', $campaign->uid) }}"><span class="material-icons-outlined">
arrow_forward
</span> {{ trans('messages.view_log') }}</a>
        </div>
