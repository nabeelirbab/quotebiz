    ...
    <div class="col-md-8">
        <ul class="modern-listing big-icon no-top-border-list mt-0">
            @foreach (Acelle\Model\Campaign::types() as $key => $type)
                ...
                <li>
                    <a href="{{ action("Admin\CampaignController@create", ["type" => $key]) }}" class="btn btn-secondary">{{ trans('messages.choose') }}</a>
                    <div class="d-flex pe-4">
                        <a href="{{ action("Admin\CampaignController@create", ["type" => $key]) }}">
                        ...
                        <div>
                            <h4 class="mb-1"><a href="{{ action("Admin\CampaignController@create", ["type" => $key]) }}">{{ trans('messages.' . $key) }}</a></h4>
                            <p>
        ...
        <div class="">
            <a href="{{ action('Admin\CampaignController@index') }}" role="button" class="btn btn-secondary">
