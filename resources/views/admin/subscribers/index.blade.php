...
@section('content')
	...
	<div class="d-flex my-4">
		...
		<div class="text-end">
			<a href="{{ action("Admin\SubscriberController@create", $list->uid) }}" role="button" class="btn btn-secondary">
...
add
	...
	<div class="listing-form subscribers-list"
		data-url="{{ action('Admin\SubscriberController@listing', $list->uid) }}"
						...
						<div class="btn-group list_actions me-2" style="display:none">
							...
							<ul class="dropdown-menu">
								<li>
									...
									href="{{ action('Admin\SubscriberController@assignValues', $list->uid) }}">
...
control_point_duplicate
								...
								<li>
									<a class="dropdown-item"  link-method="POST" link-confirm="{{ trans('messages.subscribe_subscribers_confirm') }}"
										href="{{ action('Admin\SubscriberController@subscribe', $list->uid) }}">
										<span class="material-icons-outlined">
mark_email_read
								...
								<li>
									<a class="dropdown-item"
										...
										href="{{ action('Admin\SubscriberController@unsubscribe', $list->uid) }}">
										<span class="material-icons-round">
logout
								...
								<li>
									<a class="dropdown-item list-action-single"
										link-method="POST"
										link-confirm="{{ trans('messages.subscribers.resend_confirmation_email.confirm') }}" href="{{ action('Admin\SubscriberController@resendConfirmationEmail', $list->uid) }}">
										<span class="material-icons-outlined">
mark_email_read
...
exit_to_app
								...
								<li>
									<a class="dropdown-item list-action-single"
										...
										href="{{ action('Admin\SubscriberController@delete', $list->uid) }}">
										<span class="material-icons-outlined">
delete_outline
								...
								<li>
									<a
										href="{{ action('Admin\SubscriberController@bulkDelete', $list->uid) }}"
	...
	<script>
        var SubscribersIndex = {
            ...
            getList: function() {
				if (this.list == null) {
					this.list = makeList({
						url: '{{ action('Admin\SubscriberController@listing', $list->uid) }}',
