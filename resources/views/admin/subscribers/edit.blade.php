    ...
    <div class="row mt-4">
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="sub-section">
                <form enctype="multipart/form-data"  action="{{ action('Admin\SubscriberController@update', ['list_uid' => $list->uid, "uid" => $subscriber->uid]) }}" method="POST" class="form-validate-jqueryz">
                    {{ csrf_field() }}
                    ...
                    <div class="tags mb-4" style="clear:both">
                        ...
                        @if ($subscriber->getTags())
                            @foreach ($subscriber->getTags() as $tag)
                                <a href="{{ action('Admin\SubscriberController@removeTag', [
...
close
                    ...
                    <div class="d-flex align-items-top">
                        <div>
                            @include('helpers._upload',['src' => (isSiteDemo() ? 'https://i.pravatar.cc/300' : action('Admin\SubscriberController@avatar',  $subscriber->uid)), 'dragId' => 'upload-avatar', 'preview' => 'image'])
                    ...
                    <a href="{{ action('Admin\SubscriberController@index', $list->uid) }}" class="btn btn-link"><i class="icon-cross2"></i> {{ trans('messages.cancel') }}</a>
            ...
            <div class="sub-section">
                ...
                @if (is_null($subscriber->verification_status))
                    ...
                    <form enctype="multipart/form-data" action="{{ action('Admin\SubscriberController@startVerification', ['uid' => $subscriber->uid]) }}" method="POST" class="form-validate-jquery">
                        {{ csrf_field() }}
