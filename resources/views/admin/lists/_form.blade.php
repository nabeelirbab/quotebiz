        ...
        <div class="col-md-6">
            <div class="hiddable-cond" data-control="[name=use_default_sending_server_from_email]" data-hide-value="1">
                @include('helpers.form_control', [
                    ...
                    'url' => action('Admin\SenderController@dropbox'),
                    'empty' => trans('messages.sender.dropbox.empty'),
                    'error' => trans('messages.sender.dropbox.error', [
                        'sender_link' => action('Admin\SenderController@index'),
                    ]),
...
<div class="sub_section">
    <h3 class="text-semibold">
        ...
        <span class="subhead">{!! trans('messages.default_from_your_contact_information', ['link' => action('Admin\AccountController@contact')]) !!}</span>
    </h3>
    <div class="row">
        <div class="col-md-6">
