...
@section('page_header')
	<div class="page-title">
		<ul class="breadcrumb breadcrumb-caret position-right">
			...
			<li class="breadcrumb-item"><a href="{{ action("Admin\MailListController@index") }}">{{ trans('messages.lists') }}</a></li>
		</ul>
		<h1>
...
@section('content')
	<form action="{{ action('Admin\MailListController@store') }}" method="POST" class="form-validate-jqueryz">
		{{ csrf_field() }}
		@include("lists._form")
		<hr>
		<div class="text-left">
