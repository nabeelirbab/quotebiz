                        ...
                        <div class="dropdown list_actions" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a
                                        class="dropdown-item"
                                        link-confirm-url="{{ action('Admin\MailListController@deleteConfirm') }}"
                                        link-method="POST"
                                        href="{{ action('Admin\MailListController@delete') }}"
                                    >
...
search
            ...
            <div class="text-end">
                <a href="{{ action("Admin\MailListController@create") }}" role="button" class="btn btn-secondary">
                    <span class="material-icons-round">
                        add
    ...
    <script>
        var ListsIndex = {
            ...
            getList: function() {
                if (this.list == null) {
                    this.list = makeList({
                        url: '{{ action('Admin\MailListController@listing') }}',
