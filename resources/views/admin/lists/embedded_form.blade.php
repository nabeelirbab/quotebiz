...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="EmbeddedForm" action="{{ action("Admin\MailListController@embeddedForm", $list->uid) }}" class="embedded-options-form">
                {{ csrf_field() }}
    ...
    <div class="embedded-form-result">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <iframe class="embedded_form" src="{{ action("Admin\MailListController@embeddedFormFrame", $list->uid) }}"></iframe>
            </div>
        </div>
    </div>
