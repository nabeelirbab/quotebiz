...
@section('content')
    <div id="Automation2IndexContainer" class="listing-form"
        data-url="{{ action('Admin\Automation2Controller@listing') }}"
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item"
                                    ...
                                    href="{{ action('Admin\Automation2Controller@enable') }}"
                                >
...
play_arrow
                            ...
                            <li>
                                <a class="dropdown-item" link-method="PATCH" link-confirm="{{ trans('messages.disable_automations_confirm') }}" href="{{ action('Admin\Automation2Controller@disable') }}">
                                    <span class="material-icons-outlined me-2">
hide_source
</span> {{ trans('messages.disable') }}</a></li>
                            <li>
                                <a class="dropdown-item" link-method='delete' link-confirm="{{ trans('messages.delete_automations_confirm') }}" href="{{ action('Admin\Automation2Controller@delete') }}">
                                <span class="material-icons-outlined me-2">
delete_outline
...
search
            ...
            <div class="text-end">
                <a href="{{ action("Admin\Automation2Controller@wizard") }}" role="button" class="btn btn-secondary create-automation2">
                    <span class="material-icons-round">
add
    ...
    <script>
        var Automation2Index = {
            getList: function() {
                return makeList({
                    url: '{{ action('Admin\Automation2Controller@listing') }}',
    ...
    <script>
        ...
        function showCreateCampaignPopup() {
            var url = '{{ action("Admin\Automation2Controller@wizardTrigger") }}';
