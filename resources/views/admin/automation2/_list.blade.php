    ...
    >
        @foreach ($automations as $key => $automation)
            <tr>
                ...
                <td>
                    <a class="kq_search fw-600 d-block list-title" href="{{ action('Admin\Automation2Controller@edit', $automation->uid) }}">
                        {{ $automation->name }}
                    </a>
                ...
                <td class="text-end text-nowrap">
                    @if (\Gate::allows('update', $automation))
                        <a data-popup="tooltip" href="{{ action('Admin\Automation2Controller@edit', $automation->uid) }}" role="button" class="btn btn-secondary btn-icon">
                                ...
                                @can('enable', $automation)
                                    <li>
                                        <a
                                            ...
                                            href="{{ action('Admin\Automation2Controller@enable', ["uids" => $automation->uid]) }}"
                                        >
                                ...
                                @can('disable', $automation)
                                    <li>
                                        <a
                                            ...
                                            href="{{ action('Admin\Automation2Controller@disable', ["uids" => $automation->uid]) }}"
                                        >
                                            <span class="material-icons-outlined me-2">
hide_source
                                ...
                                @if (\Gate::allows('delete', $automation))
                                    <li>
                                        <a  
                                            ...
                                            href="{{ action('Admin\Automation2Controller@delete', ["uids" => $automation->uid]) }}"
                                        >
                                            <span class="material-icons-outlined me-2">
delete_outline
