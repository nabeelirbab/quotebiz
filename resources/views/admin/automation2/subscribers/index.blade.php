...
@section('page_header')
	<main class="container px-3 pt-4">
		<ul class="breadcrumb breadcrumb-caret position-right">
			...
			<li class="breadcrumb-item"><a href="{{ action("Admin\Automation2Controller@index") }}">{{ trans('messages.automations') }}</a></li>
...
@section('content')
	<main class="container px-3">
		<div class="listing-form"
			data-url="{{ action('Admin\Automation2Controller@subscribersList', $automation->uid) }}"
...
exit_to_app
	...
	<script>
        var SubscribersIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('Admin\Automation2Controller@subscribersList', $automation->uid) }}',
