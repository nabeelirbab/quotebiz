...
<form action="{{ action('Admin\Automation2Controller@emailSetup', $automation->uid) }}" method="POST" class="form-validate-jqueryz">
    {{ csrf_field() }}
    ...
    <div class="trigger-action mt-4">    
        ...
        <a onclick="popupwindow('{{ action('Admin\Automation2Controller@templatePreview', [
                            'uid' => $automation->uid,
                            'email_uid' => $email->uid,
...
<div class="mt-4 d-flex py-3">
    <div>
        ...
        <div class="mt-3">
            <a href="{{ action('Admin\Automation2Controller@emailDelete', [
                'uid' => $automation->uid,
                'email_uid' => $email->uid,
...
<script>
    ...
    $('.email-settings-change').click(function(e) {
        ...
        var url = '{{ action('Admin\Automation2Controller@emailTemplate', ['uid' => $automation->uid, 'email_uid' => $email->uid]) }}';
