        ...
        <div class="col-md-12">
            <div class="sub-section d-flex">
                    ...
                    <div class="media-left">
                        <div class="main">
                            ...
                            @if (in_array(Acelle\Model\Setting::get('builder'), ['both','pro']) && $email->template->builder)
                                <a href="{{ action('Admin\Automation2Controller@templateEdit', [
                                        'uid' => $automation->uid,
                                        'email_uid' => $email->uid,
                            ...
                            @if (in_array(Acelle\Model\Setting::get('builder'), ['both','classic']))
                                <a href="{{ action('Admin\Automation2Controller@templateEditClassic', [
                                        'uid' => $automation->uid,
                                        'email_uid' => $email->uid,
                            ...
                            @endif
                            <a href="{{ action('Admin\Automation2Controller@templateRemove', [
                                    'uid' => $automation->uid,
                                    'email_uid' => $email->uid,
                ...
                <div class="template-thumb-container">
                    ...
                    />
                    <a
                        onclick="popupwindow('{{ action('Admin\Automation2Controller@templatePreview', [
                            'uid' => $automation->uid,
                            'email_uid' => $email->uid,
            ...
            <div class="text-end mt-5">
                ...
                <a href="javascript:;" onclick="popup.load('{{ action('Admin\Automation2Controller@emailConfirm', [
                    'uid' => $automation->uid,
                    'email_uid' => $email->uid
