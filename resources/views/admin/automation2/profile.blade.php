                        ...
                        <div class="btn-group btn-group-sm" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item profile-remove-contact"
                                    href="{{ action('Admin\Automation2Controller@removeContact', [
                                        'uid' => $automation->uid,
                                ...
                                <a class="dropdown-item profile-tag-contact"
                                    href="{{ action('Admin\Automation2Controller@tagContact', [
                                        'uid' => $automation->uid,
                                        'contact_uid' => $contact->uid,
                                    ]) }}"
                    ...
                    <div class="tags mt-3">
                        @if ($contact->getTags())
                            @foreach ($contact->getTags() as $tag)
                                <a href="{{ action('Admin\Automation2Controller@removeTag', [
                                    'uid' => $automation->uid,
                                    'contact_uid' => $contact->uid,
                                    'tag' => $tag,
...
close
                            ...
                            @endforeach
                        @else
                            <a href="{{ action('Admin\Automation2Controller@tagContact', [
                                        'uid' => $automation->uid,
                                        'contact_uid' => $contact->uid,
