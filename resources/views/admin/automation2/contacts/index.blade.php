...
@section('content')
    ...
    <div class="contacts-stats-boxes d-flex align-items-center" style="pointer-events: none;">
        <div class="contacts-stats-box" onclick="timelinePopup.load('{{ action('Admin\Automation2Controller@contacts', [
            'uid' => $automation->uid,
            'type' => 'in_action',
        ]) }}')">
        ...
        <div class="contacts-stats-box skipped" onclick="timelinePopup.load('{{ action('Admin\Automation2Controller@contacts', [
            'uid' => $automation->uid,
            'type' => 'pending',
        ]) }}')">
        ...
        <div class="contacts-stats-box error" onclick="timelinePopup.load('{{ action('Admin\Automation2Controller@contacts', [
            'uid' => $automation->uid,
            'type' => 'error',
        ]) }}')">
            <label>0</label>
    ...
    <script>
        var listContact = makeList({
            url: '{{ action('Admin\Automation2Controller@contactsList', [
                'uid' => $automation->uid,
                'action_id' => request()->action_id,
                'type' => request()->type,
            ]) }}',
