        ...
        <div class="col-md-12">
            <ul class="modern-listing big-icon no-top-border-list mt-0">
                ...
                @foreach (Auth::user()->customer->getSendingServertypes() as $key => $type)
                    ...
                    <li>
                        <a href="{{ url('sending_servers/create', ["type" => $key]) }}" class="btn btn-secondary">{{ trans('messages.choose') }}</a>
                        <a href="{{ url('sending_servers/create', ["type" => $key]) }}">
                        ...
                        <h4><a href="{{ url('sending_servers/create', ["type" => $key]) }}">{{ trans('messages.' . $key) }}</a></h4>
                        <p>
            ...
            <div class="">
                <a href="{{ url('sending_servers') }}" role="button" class="btn btn-secondary">
