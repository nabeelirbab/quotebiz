        ...
        <div class="col-md-6">
            ...
            <p>
                <a link-confirm="{{ trans('messages.reset_list_verification_confirm') }}" link-method="POST" class="btn btn-secondary"
                    href="{{ url("lists/'.$list->uid.'/verification/reset") }}">
        ...
        <div class="col-md-6">
            ...
            <script>
                ...
                var EmailVerificationChart = {
                    url: '{{ url('lists/'.$list->uid.'/email-verification/chart') }}',
                    getChart: function() {
    ...
    <script>
        var AcelleList = {
            ...
            start: function() {
                ...
                $.ajax({
                    url: '{{ url('lists/'.$list->uid.'/verification/start') }}',
                    type: 'POST',
                    data: {
                        '_token': token,
            ...
            cancel: function() {
                ...
                $.ajax({
                    ...
                    success: function(result, textStatus, jqXHR) {
                        ...
                        window.location.href = '{{ url("lists/'.$list->uid.'/verification") }}';
                    }
                }).fail(function(jqXHR, textStatus, errorThrown) {
                    alert(errorThrown);
