    ...
    <div class="row mt-4">
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="sub-section">
                <form enctype="multipart/form-data"  action="{{ url('lists/'.$list->uid.'/subscribers/'.$subscriber->uid.'/update') }}" method="POST" class="form-validate-jqueryz">
                    {{ csrf_field() }}
...
close
                    ...
                    <a href="{{ url('lists/'.$list->uid.'/subscribers') }}" class="btn btn-link"><i class="icon-cross2"></i> {{ trans('messages.cancel') }}</a>
            ...
            <div class="sub-section">
                ...
                @if (is_null($subscriber->verification_status))
                    ...
                    <form enctype="multipart/form-data" action="{{ url('subscriber/'.$subscriber->uid.'/verification/reset') }}" method="POST" class="form-validate-jquery">
                        {{ csrf_field() }}
    ...
    <script>
        ...
        $('.profile-tag-contact').click(function(e) {
            ...
            var url = '{{ url('lists/'.$subscriber->mailList->uid.'/subscriber/'.$subscriber->uid.'/update-tags') }}';
    ...
    message: response.message
        ...
        $('.profile-remove-contact').click(function(e) {
            ...
            var url = '{{ url('lists/'.$subscriber->mailList->uid.'/subscribers/delete') }}';
    ...
    message: response.message
                            ...
                            addMaskLoading('{{ trans('messages.subscriber.deleted.redirect') }}', function() {
                                window.location = '{{ url('lists/'.$subscriber->mailList->uid.'/subscribers') }}';
                            });
                        }
                    });
                },
