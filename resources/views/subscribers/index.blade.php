...
@section('content')
	...
	<div class="d-flex my-4">
		...
		<div class="text-end">
			<a href="{{ url("lists/'.$list->uid.'/subscribers/create") }}" role="button" class="btn btn-secondary">
...
add
	...
	<div class="listing-form subscribers-list"
		data-url="{{ url('lists/'.$list->uid.'/subscribers/listing') }}"
						...
						<div class="btn-group list_actions me-2" style="display:none">
							...
							<ul class="dropdown-menu">
								<li>
									...
									href="{{ url('lists/'.$list->uid.'/subscribers/assign-values') }}">
...
control_point_duplicate
								...
								<li>
									<a class="dropdown-item"  link-method="POST" link-confirm="{{ trans('messages.subscribe_subscribers_confirm') }}"
										href="{{ url('lists/'.$list->uid.'/subscribers/subscribe') }}">
										<span class="material-icons-outlined">
mark_email_read
								...
								<li>
									<a class="dropdown-item"
										...
										href="{{ url('lists/'.$list->uid.'/subscribers/unsubscribe') }}">
										<span class="material-icons-round">
logout
								...
								<li>
									<a class="dropdown-item list-action-single"
										link-method="POST"
										link-confirm="{{ trans('messages.subscribers.resend_confirmation_email.confirm') }}" href="{{ url('lists/'.$list->uid.'/subscribers/resend/confirmation-email') }}">
										<span class="material-icons-outlined">
mark_email_read
								...
								<li>
									<a href="#" class="dropdown-item copy_move_subscriber"
										data-url="{{ url('lists/'.$list->uid.'/copy-move-from/copy') }}">
											<span class="material-icons-outlined">
copy_all
								...
								<li>
									<a href="#move" class="dropdown-item copy_move_subscriber"
										data-url="{{ url('lists/'.$list->uid.'/copy-move-from/move') }}">
										<span class="material-icons-outlined">
exit_to_app
								...
								<li>
									<a class="dropdown-item list-action-single"
										...
										href="{{ url('lists/'.$list->uid.'/subscribers/delete') }}">
										<span class="material-icons-outlined">
delete_outline
								...
								<li>
									<a
										href="{{ url('lists/'.$list->uid.'/subscribers/bulk-delete') }}"
	...
	<script>
        var SubscribersIndex = {
            ...
            getList: function() {
				if (this.list == null) {
					this.list = makeList({
						url: '{{ url('lists/'.$list->uid.'/subscribers/listing') }}',
