    ...
    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-bottom top-user-menus" aria-labelledby="content-menu">
        ...
        <li class="p-3" style="width: 300px">
            <div class="d-flex mb-2">
                ...
                <div>
                    <a href="{{ url('account/profile') }}" class="fs-6 fw-600 d-flex align-items-center">
        ...
        <!--     @can("admin_access", Auth::user())
            ...
            <li class="nav-item" rel0="SubscriptionController/index">
                <a href="{{ url('account/subscription') }}" class="dropdown-item d-flex align-items-center">
                <i class="navbar-icon">
            ...
            <li class="nav-item" rel0="AccountController/billing"><a href="{{ url("account/billing") }}" class="dropdown-item d-flex align-items-center">
                <i class="navbar-icon">
        ...
        @endif
        <li class="nav-item" rel0="AccountController/profile"><a href="{{ url("account/profile") }}" class="dropdown-item d-flex align-items-center">
            <i class="navbar-icon">
