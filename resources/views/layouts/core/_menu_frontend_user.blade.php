<li class="nav-item dropdown">
    <a href="{{ url('templates') }}" class="nav-link d-flex align-items-center ps-3 pe-1 py-3 lvl-1 dropdown-toggle"
    ...
    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-bottom top-user-menus" aria-labelledby="content-menu">
        ...
        <li class="p-3" style="width: 300px">
            <div class="d-flex mb-2">
                ...
                <div>
                    <a href="{{ url('admin/account/profile') }}" class="fs-6 fw-600 d-flex align-items-center">
        ...
        <!--     @can("admin_access", Auth::user())
                ...
                </i>Super Admin View</a></li>
                <li class="divider"></li>
            @endif -->
            <!-- @if (request()->user()->customer->activeSubscription())
                <li class="nav-item">
                    <a href="#" class="dropdown-item top-quota-button d-flex align-items-center" data-url="{{ url("account/quota_log") }}">
                    <i class="navbar-icon">
            ...
            <li class="nav-item" rel0="SubscriptionController/index">
                <a href="{{ url('admin/account/subscription') }}" class="dropdown-item d-flex align-items-center">
                <i class="navbar-icon">
            ...
            <li class="nav-item" rel0="AccountController/billing"><a href="{{ url("admin/account/billing") }}" class="dropdown-item d-flex align-items-center">
                <i class="navbar-icon">
        ...
        @endif
        <li class="nav-item" rel0="AccountController/profile"><a href="{{ url("admin/account/profile") }}" class="dropdown-item d-flex align-items-center">
            <i class="navbar-icon">
