                    ...
                    <div class="nk-block mb-3">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <form action="{{ url('addsupport') }}" class="form-contact" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="type" id="type-general" value="general" checked>
                                                <label class="custom-control-label" for="type-general">A general enquiry</label>
                                            </div>
                                        </div><!-- .col -->
                                        <div class="col-md-6">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input" name="type" id="type-problem" value="problem">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select" data-search="off" name="category" data-ui="lg">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select" data-search="off" name="priority" data-ui="lg">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control form-control-lg" name="subject" placeholder="Write your problem... ">
                                                </div>
                                            </div>
                                        </div><!-- .col -->
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <div class="form-editor-custom">
                                                        <textarea class="form-control form-control-lg no-resize" placeholder="Write your message" name="message"></textarea>
