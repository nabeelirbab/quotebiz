            ...
            <div class="nk-data data-list">
                ...
                <div class="data-item">
                    <div class="data-col">
                        ...
                        <span class="data-value text-soft">@if(Auth::user()->mobileno) {{Auth::user()->mobileno}} @else Not add yet @endif</span>
                    </div>
                </div><!-- data-item --> 
                <div class="data-item">
                    <div class="data-col">
...
<input type="text" class="form-control" id="full-name" value="{{Auth::user()->first_name}}" name="first_name" placeholder="Enter Full name">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label class="form-label" for="display-name">Last Name</label>
<input type="text" class="form-control" id="display-name" value="{{Auth::user()->last_name}}" name="last_name" placeholder="Enter display name">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label class="form-label" for="personal-email">Email</label>
<input type="email" class="form-control" id="personal-email" value="{{Auth::user()->email}}" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label class="form-label" for="phone-no">Phone Number</label>
<input type="text" class="form-control" id="phone-no" value="{{Auth::user()->mobileno}}" name="mobileno" placeholder="Phone Number">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
...
<input type="text" class="form-control" name="zipcode" id="nationality" value="{{Auth::user()->zipcode}}">
</div>
</div>
