...
@section('content')
    <div id="CampaignsIndexContainer" class="listing-form top-sticky"
        data-url="{{ url('campaigns/listing') }}"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownListActions">
                                <li>
                                    <a class="action dropdown-item"
                                        link-method="POST"
                                        link-confirm="{{ trans('messages.restart_campaigns_confirm') }}" href="{{ url('campaigns/restart') }}">
                                        <span class="material-icons-outlined me-2">
restore
</span> {{ trans("messages.restart") }}</a></li>
                                <li><a class="action dropdown-item"
                                    link-method="POST"
                                    link-confirm="{{ trans('messages.pause_campaigns_confirm') }}" href="{{ url('campaigns/pause') }}">
                                    <span class="material-icons-outlined me-2">
motion_photos_pause
</span> {{ trans("messages.pause") }}</a></li>
                                <li><a class="action dropdown-item"
                                    link-method="POST"
                                    link-confirm="{{ trans('messages.delete_campaigns_confirm') }}" href="{{ url('campaigns/delete') }}">
                                    <span class="material-icons-outlined me-2">
delete_outline
