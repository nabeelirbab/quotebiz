           ...
           @foreach($customs as $key=>$question)
            ...
            <div class="removeQuestion mt-4" style="background: #f5f6fa;padding: 20px;border-radius:15px">
             <div class="row mb-4">
                ...
                <div class="col-xs-6 col-md-2" style="padding-right: 0;"><span title="Remove Question" class=" removeQuestions material-icons-round remove-icon xtooltip tooltipstered lh-1 float-end fs-1" style="cursor: pointer;">remove_circle</span><input type="hidden" name="custom_field_id[{{$key}}]" value="">
                </div> 
               </div>
                <div class="row">
