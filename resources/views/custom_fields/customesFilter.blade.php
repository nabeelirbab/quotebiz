                 @foreach($categories as $category)
                  ...
                  <div class="accordion-item">
                      ...
                      <div class="accordion-body collapse show" id="accordion-item-{{$category->id}}" data-parent="#accordion{{$category->id}}">
                        ...
                        @if(count($category->customs) > 0) 
                        @foreach($category->customs as $question)
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class=" dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li><a href="{{ url('admin/customs/add?category_id='.$question->category_id)}}"><em class="icon ni ni-repeat"></em><span>Edit</span></a></li>
                                                   
                                                    <li class="divider"></li>
                                                   
                                                    <li><a href="{{ url('admin/customs/delete/'.$question->id)}}"><em class="icon ni ni-na"></em><span>Delete</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
