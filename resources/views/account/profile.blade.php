...
<div class="media-body text-center">
    ...
    <br /><br />
    <a href="#upload" onclick="$('input[name=image]').trigger('click')" class="btn btn-primary me-1"><span style="width: fit-content !important;" class="material-icons-outlined">
file_download
</span> {{ trans('messages.upload') }}</a>
    <a href="#remove" class="btn btn-secondary remove-profile-image"><span style="width: fit-content !important;" class="material-icons-outlined">
delete_outline
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="admin_address" value="{{ $user->admin_address }}">
</div>
...
@include('helpers.form_control', ['type' => 'text', 'value' => $customer->user->email,'name' => 'email', 'readonly' => true, 'help_class' => 'profile', 'rules' => $user->rules()])
