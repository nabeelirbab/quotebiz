                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class=" dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    ...
                                                    <li><a href="{{ url('questions/add-question?category_id='.$question->category_id)}}"><em class="icon ni ni-repeat"></em><span>Edit</span></a></li>
                                                   
                                                    <li class="divider"></li>
                                                   
                                                    <li><a href="{{ url('questions/delete/'.$question->id)}}"><em class="icon ni ni-na"></em><span>Delete</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
