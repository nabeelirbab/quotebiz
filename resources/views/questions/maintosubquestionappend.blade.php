           ...
           @foreach($questions as $key=>$question)
            ...
            <div class="removeQuestion mt-4" style="background: #f5f6fa;padding: 20px;border-radius:15px">
             <div class="row mb-4">
                ...
                <div class="col-xs-6 col-md-2" style="padding-right: 0;"><span title="Remove Question" class=" removeQuestions material-icons-round remove-icon xtooltip tooltipstered lh-1 float-end fs-1" style="cursor: pointer;color: #44e8bc;">remove_circle</span><input type="hidden" name="question_id[{{$key}}]" value="">
                </div> 
               </div>
                <div class="row">
                 ...
                 @foreach($question->choices as $key2=>$choice)
                    ...
                    <div class="col-sm-2 pr-1"><span title="Remove Option" class="removeChoice material-icons-round remove-icon xtooltip tooltipstered  float-end fs-3" style="cursor: pointer;line-height:3!important;color: #44e8bc;">remove_circle</span><input type="hidden" value="" name="choice_id[{{$key}}][]"></div>
                    </div>
                    @endforeach
                    @endif
                </div>
