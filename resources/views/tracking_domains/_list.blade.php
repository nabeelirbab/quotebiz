            ...
            <tr>
                ...
                <td>
                    <h5 class="m-0 text-bold">
                        <a class="kq_search d-block" href="{{ url('tracking_domains/'.$trackingDomain->uid) }}">{{ $trackingDomain->name }}</a>
                    </h5>
                ...
                <td class="text-end">
                    ...
                    @if (Auth::user()->customer->can('read', $trackingDomain))
                        <a href="{{ url('tracking_domains/'.$trackingDomain->uid)}}" data-popup="tooltip"
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a
                                        ...
                                        link-confirm="{{ trans('messages.delete_tracking_domains_confirm') }}" href="{{ url('tracking_domains/delete', ["uids" => $trackingDomain->uid]) }}">
                                        <span class="material-icons-outlined">
delete_outline
