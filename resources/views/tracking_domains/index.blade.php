...
@section('page_header')
    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li class="breadcrumb-item"><a href="{{ url("tracking_domains") }}">{{ trans('messages.tracking_domains') }}</a></li>
        </ul>
        <h1>
...
@section('content')
    ...
    <div class="listing-form"
        data-url="{{ url('tracking_domains/listing') }}"
                    ...
                    <div class="filter-box">
                        ...
                        <div class="dropdown list_actions" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" link-confirm="{{ trans('messages.delete_tracking_domains_confirm') }}" href="{{ url('tracking_domains/delete') }}"><span class="material-icons-outlined">
delete_outline
...
search
            ...
            @if (Auth::user()->customer->can('create', new Acelle\Model\TrackingDomain()))
                <div class="text-end">
                    <a href="{{ url('tracking_domains/create') }}" role="button" class="btn btn-secondary">
                        <span class="material-icons-round">
add
    ...
    <script>
        var TrackingDomainsIndex = {
            getList: function() {
                return makeList({
                    url: '{{ url('tracking_domains/listing') }}',
