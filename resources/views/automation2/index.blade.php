...
@section('content')
    <div id="Automation2IndexContainer" class="listing-form"
        data-url="{{ url('automation2/listing') }}"
...
play_arrow
                            ...
                            <li>
                                <a class="dropdown-item" link-method="PATCH" link-confirm="{{ trans('messages.disable_automations_confirm') }}" href="{{ url('automation2/disable') }}">
                                    <span class="material-icons-outlined me-2">
hide_source
</span> {{ trans('messages.disable') }}</a></li>
                            <li>
                                <a class="dropdown-item" link-method='delete' link-confirm="{{ trans('messages.delete_automations_confirm') }}" href="{{ url('automation2/delete') }}">
                                <span class="material-icons-outlined me-2">
delete_outline
...
search
            ...
            <div class="text-end">
                <a href="{{ url("automation2/wizard") }}" role="button" class="btn btn-secondary create-automation2">
                    <span class="material-icons-round">
add
    ...
    <script>
        ...
        function showCreateCampaignPopup() {
            var url = '{{ url("automation2/wizard/trigger") }}';
