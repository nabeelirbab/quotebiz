			...
			<tbody>
				<tr>
					<td align="center" valign="top" style="padding:20px 10px">
						<a href="" >
						   <img alt="Quotebiz.io" src="http://192.241.139.188/demos/updatedquotebiz/public/images/logo-dark.png" width="105" height="30" style="display:block;width:105px;max-width:105px;min-width:105px;font-family:'Lato',Helvetica,Arial,sans-serif;color:#ffffff;font-size:18px" border="0" class="CToWUd">
						</a>
