...
<li class="nav-item">
    <a class="nav-link active" data-toggle="tab" href="#parmanent"><em class="icon ni ni-user-circle"></em><span>New Quotes</span></a>
</li>
<!-- <li class="nav-item">
...
<div class="tab-pane active" id="parmanent">
    <div class="nk-tb-list nk-tb-ulist border-light">
        ...
        <!-- .nk-tb-item -->
        @foreach($pendingquotes as $key => $quote)
            ...
            <div style="margin-right: 10px;">
             <h5>{{$quote->category->category_name}}</h5>
                ...
                <div>
                  ...
                  <div class="row card-panel" style="max-height: 70%;overflow: auto;">
                  <br>
