...
class MailListController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            return redirect()->action('Admin\MailListController@edit', $list->uid);
        }
    }
    ...
    public function deleteConfirm(Request $request)
    {
        ...
        return view('admin.lists.delete_confirm', [
            'lists' => $lists,
        ]);
    }
    ...
    public function overview(Request $request)
    {
        ...
        return view('admin.lists.overview', [
            'list' => $list,
        ]);
    }
    ...
    public function quickView(Request $request)
    {
        ...
        return view('admin.lists._quick_view', [
            'list' => $list,
        ]);
    }
    ...
    public function copy(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.lists.copy', [
                    'list' => $list,
    ...
    public function embeddedForm(Request $request)
    {
        ...
        return view('admin.lists.embedded_form', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormFrame(Request $request)
    {
        ...
        return view('admin.lists.embedded_form_frame', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormCaptcha(Request $request)
    {
        ...
        return view('admin.lists.embedded_form_captcha', [
            'list' => $list,
        ]);
    }
    ...
    public function embeddedFormSubscribe(Request $request)
    {
        ...
        if (!$success) {
            ...
            return view('admin.lists.embedded_form_captcha_invalid', [
                'errors' => $errs,
                'list' => $list,
                'back_link' => $url,
            ]);
        ...
        if ($validator->fails()) {
            ...
            return view('admin.lists.embedded_form_errors', [
                'errors' => $errs,
                'list' => $list,
                'back_link' => $url,
            ]);
    ...
    public function verification(Request $request)
    {
        ...
        if ($currentJob) {
            return view('admin.lists.email_verification', [
                'list' => $list,
                'currentJobUid' => $currentJob->uid,
                'cancelUrl' => action('Admin\MailListController@stopVerification', [ 'uid' => $list->uid, 'job_uid' => $currentJob->uid ]),
                'progressCheckUrl' => action('Admin\MailListController@verificationProgress', [ 'uid' => $list->uid, 'job_uid' => $currentJob->uid ]),
            ]);
        } else {
            return view('admin.lists.email_verification', [
                'list' => $list,
    ...
    public function startVerification(Request $request)
    {
        ...
        return response()->json([
            ...
            'cancelUrl' => action('Admin\MailListController@stopVerification', [ 'uid' => $list->uid, 'job_uid' => $job->uid ]),
            'progressCheckUrl' => action('Admin\MailListController@verificationProgress', [ 'uid' => $list->uid, 'job_uid' => $job->uid ]),
        ]);
    }
    ...
    public function resetVerification(Request $request)
    {
        ...
        return redirect()->action('Admin\MailListController@verification', $list->uid);
    }
    ...
    public function cloneForCustomersChoose(Request $request, $uid)
    {
        ...
        return view('admin.lists.cloneForCustomersChoose', [
            'list' => $list,
            'options' => $options,
        ]);
    }
