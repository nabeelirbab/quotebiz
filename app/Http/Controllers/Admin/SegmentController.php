...
class SegmentController extends Controller
{
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.segments._list', [
            'segments' => $segments,
            'list' => $list,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            return redirect()->action('Admin\SegmentController@index', $list->uid);
        }
    }
    ...
    public function subscribers(Request $request)
    {
        ...
        return view('admin.segments.subscribers', [
    ...
    public function sample_condition(Request $request)
    {
        ...
        return view('admin.segments._sample_condition', [
            'list' => $list,
        ]);
    }
    ...
    public function selectBox(Request $request)
    {
        ...
        return view('admin.segments._select_box', [
    ...
    public function conditionValueControl(Request $request)
    {
        ...
        return view('admin.segments._condition_value_control', [
