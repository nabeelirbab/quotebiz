...
class SettingController extends Controller
{
    ...
    public function updateUrls(Request $request)
    {
        ...
        Setting::set('url_unsubscribe', url('c/SUBSCRIBER/unsubscribe/MESSAGE_ID'));
        Setting::set('url_open_track', url('p/MESSAGE_ID/open'));
        Setting::set('url_click_track', url('p/URL/click/MESSAGE_ID'));
        Setting::set('url_delivery_handler', url('delivery/notify/'));
        Setting::set(
            'url_update_profile',
            url('lists/LIST_UID/update-profile/SUBSCRIBER_UID/SECURE_CODE')
        );
        Setting::set('url_web_view', url('campaigns/MESSAGE_ID/web-view'));
