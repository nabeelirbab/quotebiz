...
class Automation2Controller extends Controller
{
    ...
    {
        return view('admin.automation2.index');
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.automation2._list', [
    ...
    public function wizardTrigger(Request $request)
    {
        ...
        if ($request->trigger_type) {
            ...
            return view('admin.automation2.wizardTriggerOption', [
        ...
        return view('admin.automation2.wizardTrigger', [
            'types' => $types,
        ]);
    }
    ...
    public function wizardTriggerOption(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.wizardTriggerOption', [
                    'trigger_type' => $request->trigger_type,
            ...
            return view('admin.automation2.wizard', [
                'automation' => $automation,
                'trigger_type' => $request->trigger_type,
            ]);
        }
    ...
    public function wizardListFieldSelect(Request $request)
    {
        ...
        return view('admin.automation2.wizardListFieldSelect', [
            'list' => $list,
        ]);
    }
    ...
    public function wizard(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.wizard', [
                    'automation' => $automation,
                    'errors' => $validator->errors(),
                ], 400);
            }
            ...
            return response()->json([
                ...
                'url' => action('Admin\Automation2Controller@edit', ['uid' => $automation->uid])
            ], 201);
        }
    ...
    public function update(Request $request, $uid)
    {
        ...
        // redirect if fails
        if ($validator->fails()) {
            return response()->view('admin.automation2.settings', [
                'automation' => $automation,
                'errors' => $validator->errors(),
            ], 400);
        }
    ...
    public function edit(Request $request, $uid)
    {
        ...
        return view('admin.automation2.edit', [
            'automation' => $automation,
        ]);
    }
    ...
    public function settings(Request $request, $uid)
    {
        ...
        return view('admin.automation2.settings', [
            'automation' => $automation,
        ]);
    }
    ...
    public function triggerSelectPupop(Request $request, $uid)
    {
        ...
        return view('admin.automation2.triggerSelectPupop', [
            'types' => $types,
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
        ]);
    ...
    public function triggerSelectConfirm(Request $request, $uid)
    {
        ...
        return view('admin.automation2.triggerSelectConfirm', [
            'key' => $request->key,
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
            'rules' => $rules,
    ...
    public function triggerSelect(Request $request, $uid)
    {
        ...
        // redirect if fails
        if (!$result) {
            return response()->view('admin.automation2.triggerSelectConfirm', [
    ...
    public function actionSelectPupop(Request $request, $uid)
    {
        ...
        return view('admin.automation2.actionSelectPupop', [
            'types' => $types,
            'automation' => $automation,
    ...
    public function actionSelectConfirm(Request $request, $uid)
    {
        ...
        return view('admin.automation2.actionSelectConfirm', [
            'key' => $request->key,
            'automation' => $automation,
    ...
    public function conditionSetting(Request $request, $uid)
    {
        ...
        return view('admin.automation2.condition.setting', [
            'automation' => $automation,
    ...
    public function triggerEdit(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if (!$result) {
                return response()->view('admin.automation2.triggerEdit', [
                    'key' => $request->options['key'],
                    'automation' => $automation,
                    'trigger' => $automation->getTrigger(),
                    'rules' => $this->triggerRules()[$request->options['key']],
        ...
        return view('admin.automation2.triggerEdit', [
            'key' => $request->key,
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
            'rules' => $rules,
    ...
    public function actionEdit(Request $request, $uid)
    {
        ...
        return view('admin.automation2.actionEdit', [
            'key' => $request->key,
            'automation' => $automation,
    ...
    public function emailSetup(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.email.setup', [
                    'automation' => $automation,
                    'email' => $email,
                    'errors' => $validator->errors(),
                ], 400);
            ...
            return response()->json([
                ...
                'url' => action('Admin\Automation2Controller@emailTemplate', [
                    'uid' => $automation->uid,
                    'email_uid' => $email->uid,
                ]),
                'options' => [
        ...
        return view('admin.automation2.email.setup', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function emailTemplate(Request $request, $uid, $email_uid)
    {
        ...
        if (!$email->hasTemplate()) {
            return redirect()->action('Admin\Automation2Controller@templateCreate', [
                'uid' => $automation->uid,
                'email_uid' => $email->uid,
            ]);
        }

        return view('admin.automation2.email.template', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function email(Request $request, $uid)
    {
        ...
        return view('admin.automation2.email.index', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function emailConfirm(Request $request, $uid)
    {
        ...
        return view('admin.automation2.email.confirm', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templateCreate(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.create', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templateLayout(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.layout', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templateLayoutList(Request $request)
    {
        ...
        return view('admin.automation2.email.template.layoutList', [
            'automation' => $automation,
            'email' => $email,
            'templates' => $templates,
        ]);
    ...
    public function templateBuilderSelect(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.templateBuilderSelect', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templateEdit(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.edit', [
            'automation' => $automation,
    ...
    public function templateContent(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.content', [
    ...
    public function templateUpload(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.upload', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templatePreview(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.preview', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function insight(Request $request, $uid)
    {
        ...
        return view('admin.automation2.insight', [
            'automation' => $automation,
    ...
    public function contacts(Request $request, $uid)
    {
        ...
        return view('admin.automation2.contacts.index', [
            'automation' => $automation,
            'count' => $count,
    ...
    public function contactsList(Request $request, $uid)
    {
        ...
        return view('admin.automation2.contacts.list', [
            'automation' => $automation,
            'contacts' => $contacts,
        ]);
    }
    ...
    public function timeline(Request $request, $uid)
    {
        ...
        return view('admin.automation2.timeline.index', [
            'automation' => $automation,
        ]);
    }
    ...
    public function timelineList(Request $request, $uid)
    {
        ...
        return view('admin.automation2.timeline.list', [
            'automation' => $automation,
            'timelines' => $timelines,
        ]);
    }
    ...
    public function profile(Request $request, $uid, $contact_uid)
    {
        ...
        return view('admin.automation2.profile', [
            'automation' => $automation,
            'contact' => $contact,
        ]);
    }
    ...
    public function tagContact(Request $request, $uid, $contact_uid)
    {
        ...
        return view('admin.automation2.contacts.tagContact', [
            'automation' => $automation,
            'contact' => $contact,
        ]);
    }
    ...
    public function tagContacts(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.contacts.tagContacts', [
                    'automation' => $automation,
                    'subscribers' => $subscribers,
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.contacts.tagContacts', [
            'automation' => $automation,
            'subscribers' => $subscribers,
        ]);
    }
    ...
    public function copyToNewList(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.contacts.copyToNewList', [
                    'automation' => $automation,
                    'subscribers' => $subscribers,
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.contacts.copyToNewList', [
            'automation' => $automation,
            'subscribers' => $subscribers,
        ]);
    }
    ...
    public function templateEditClassic(Request $request, $uid, $email_uid)
    {
        ...
        return view('admin.automation2.email.template.editClassic', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function templateEditPlain(Request $request, $uid, $email_uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.email.template.editPlain', [
                    'automation' => $automation,
                    'email' => $email,
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.email.template.editPlain', [
            'automation' => $automation,
            'email' => $email,
        ]);
    }
    ...
    public function segmentSelect(Request $request)
    {
        ...
        return view('admin.automation2.segmentSelect', [
            'automation' => $automation,
            'list' => $list,
        ]);
    }
    ...
    public function subscribers(Request $request, $uid)
    {
        ...
        return view('admin.automation2.subscribers.index', [
            'automation' => $automation,
            'list' => $list,
        ]);
    }
    ...
    public function subscribersList(Request $request, $uid)
    {
        ...
        return view('admin.automation2.subscribers._list', [
            'automation' => $automation,
            'subscribers' => $subscribers,
            'total' => $total,
            'list' => $list,
    ...
    public function subscribersShow(Request $request, $uid, $subscriber_uid)
    {
        ...
        return view('admin.automation2.subscribers.show', [
            'automation' => $automation,
    ...
    public function debug(Request $request, $uid)
    {
        ...
        switch ($type) {
            case Automation2::TRIGGER_TYPE_WELCOME_NEW_SUBSCRIBER:
                ...
                return view('admin.automation2.debug_list_subscription', [
                    'automation' => $automation,
                    'subscribers' => $subscribers,
                ]);
            ...
            case Automation2::TRIGGER_TYPE_SAY_GOODBYE_TO_SUBSCRIBER:
                ...
                return view('admin.automation2.debug_list_unsubscription', [
                    'automation' => $automation,
                    'subscribers' => $subscribers,
                ]);
            ...
            case Automation2::TRIGGER_TYPE_SAY_HAPPY_BIRTHDAY:
                ...
                return view('admin.automation2.debug', [
                    'automation' => $automation,
                    'subscribers' => $subscribers,
                ]);
    ...
    public function contactRetry(Request $request, $uid, $contact_uid)
    {
        ...
        return view('admin.automation2.contacts.list.error_row', [
            'automation' => $automation,
            'contact' => $contact,
        ]);
    }
    ...
    public function waitTime(Request $request, $uid)
    {
        ...
        return view('admin.automation2.waitTime', [
            'automation' => $automation,
        ]);
    }
    ...
    public function cartWait(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.cartWait', [
                    'automation' => $automation,
                    'trigger' => $automation->getTrigger(),
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.cartWait', [
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
        ]);
    }
    ...
    public function cartChangeList(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.cartChangeList', [
                    'automation' => $automation,
                    'trigger' => $automation->getTrigger(),
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.cartChangeList', [
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
        ]);
    }
    ...
    public function cartChangeStore(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.cartChangeSore', [
                    'automation' => $automation,
                    'trigger' => $automation->getTrigger(),
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.automation2.cartChangeSore', [
            'automation' => $automation,
            'trigger' => $automation->getTrigger(),
        ]);
    }
    ...
    public function cartStats(Request $request, $uid)
    {
        ...
        return view('admin.automation2.cart.stats', [
            'automation' => $automation,
        ]);
    }
    ...
    public function cartList(Request $request, $uid)
    {
        ...
        return view('admin.automation2.cart.list', [
            'automation' => $automation,
        ]);
    }
    ...
    public function cartItems(Request $request, $uid)
    {
        ...
        return view('admin.automation2.cart.items', [
            'automation' => $automation,
        ]);
    }
    ...
    public function operationSelect(Request $request, $uid)
    {
        ...
        return view('admin.automation2.operationSelect', [
            'automation' => $automation,
            'types' => [
                'update_contact',
                'tag_contact',
    ...
    public function operationCreate(Request $request, $uid)
    {
        ...
        return view('admin.automation2.operationCreate', [
            'automation' => $automation,
            'types' => [
                'update_contact',
                'tag_contact',
    ...
    public function operationShow(Request $request, $uid)
    {
        ...
        return view('admin.automation2.operationShow', [
            'automation' => $automation,
            'element' => $automation->getElement($request->id),
        ]);
    }
    ...
    public function operationEdit(Request $request, $uid)
    {
        ...
        return view('admin.automation2.operationEdit', [
            'automation' => $automation,
            'element' => $automation->getElement($request->id),
        ]);
    }
    ...
    public function sendTestEmail(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            try {
                ...
                return response()->view('admin.automation2.sendTestEmail', [
                    'email' => $email,
                    'error' => $ex->getMessage(),
                ], 400);
            }
        ...
        return view('admin.automation2.sendTestEmail', [
            'email' => $email,
        ]);
    }
    ...
    public function conditionWaitCustom(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.automation2.condition.conditionWaitCustom', [
                    'errors' => $validator->errors(),
                ], 400);
            }

            return view('admin.automation2.condition._wait_select');
        }

        return view('admin.automation2.condition.conditionWaitCustom');
    }
}
