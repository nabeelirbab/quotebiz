...
class SubscriberController extends Controller
{
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.subscribers._list', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admin\SubscriberController@index', $list->uid);
    }
    ...
    public function import(Request $request)
    {
        ...
        if ($currentJob) {
            return view('admin.subscribers.import', [
                ...
                'progressCheckUrl' => action('Admin\SubscriberController@importProgress', ['job_uid' => $currentJob->uid, 'list_uid' => $list->uid]),
                'cancelUrl' => action('Admin\SubscriberController@cancelImport', ['job_uid' => $currentJob->uid]),
                'logDownloadUrl' => action('Admin\SubscriberController@downloadImportLog', ['job_uid' => $currentJob->uid]),
    ...
    public function export(Request $request)
    {
        ...
        if ($currentJob) {
            return view('admin.subscribers.export', [
                'list' => $list,
                'currentJobUid' => $currentJob->uid,
                'progressCheckUrl' => action('Admin\SubscriberController@exportProgress', ['job_uid' => $currentJob->uid]),
                'cancelUrl' => action('Admin\SubscriberController@cancelExport', ['job_uid' => $currentJob->uid]),
                'downloadUrl' => action('Admin\SubscriberController@downloadExportedFile', ['job_uid' => $currentJob->uid]),
            ]);
        // GET, do not have any job
        } else {
            return view('admin.subscribers.export', [
    ...
    public function copyMoveForm(Request $request)
    {
        ...
        return view('admin.subscribers.copy_move_form', [
            'subscribers' => $subscribers,
            'from_list' => $from_list
        ]);
    }
    ...
    public function startVerification(Request $request)
    {
        ...
        try {
            ...
            return redirect()->action('Admin\SubscriberController@edit', ['list_uid' => $request->list_uid, 'uid' => $subscriber->uid]);
        } catch (\Exception $e) {
    ...
    public function updateTags(Request $request, $list_uid, $uid)
    {
        ...
        return view('admin.subscribers.updateTags', [
            'list' => $list,
            'subscriber' => $subscriber,
        ]);
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.subscribers.bulkDelete', [
                    'list' => $list,
            ...
            //
            return view('admin.subscribers.bulkDeleteConfirm', [
                'list' => $list,
                'emails' => $emails,
                'subscribers' => $subscribers,
            ]);
        ...
        return view('admin.subscribers.bulkDelete', [
            'list' => $list,
        ]);
    }
    ...
    public function assignValues(Request $request, $list_uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            // redirect if fails
            if ($validator->fails()) {
                return response()->view('admin.subscribers.assignValues', [
                    'list' => $list,
                    'subscribers' => $subscribers,
                    'errors' => $validator->errors(),
                ], 400);
        ...
        return view('admin.subscribers.assignValues', [
            'list' => $list,
            'subscribers' => $subscribers,
        ]);
    }
