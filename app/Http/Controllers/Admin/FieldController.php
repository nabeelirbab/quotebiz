...
class FieldController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                return redirect()->action('Admin\FieldController@index', $list->uid)
    ...
    public function sample(Request $request)
    {
        ...
        return view('admin.fields._form_samples', [
            'list' => $list,
            'type' => $request->type,
        ]);
    }
    ...
    public function delete(Request $request)
    {
        ...
        if ($field->tag != 'EMAIL') {
            ...
            return redirect()->action('Admin\FieldController@index', $request->list_uid);
        } else {
            // Redirect to my lists page
