...
class SubscriberController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        if ($currentJob) {
            return view('subscribers.export', [
                'list' => $list,
                'currentJobUid' => $currentJob->uid,
                'progressCheckUrl' => url('lists/export/'.$currentJob->uid.'/progress'),
                'cancelUrl' => url('lists/export/'.$currentJob->uid.'/cancel'),
                'downloadUrl' => url('lists/export/'.$currentJob->uid.'/log/download'),
            ]);
        // GET, do not have any job
        } else {
            return view('subscribers.export', [
    ...
    public function startVerification(Request $request)
    {
        ...
        try {
            ...
            return redirect('lists/'.$request->list_uid.'/subscribers/'.$subscriber->uid.'/edit');
        } catch (\Exception $e) {
